...
## Create a batch of certificates for a Pathways cohort
...
Registration for this is recorded in a google sheet from Zoom signups, with a column named `participant_name` that contains full names of participants.
This should be imported into R as a `data.frame` (usually using `{googlesheets4}` or `{datapasta}`), and is passed to the `participants_sheet` argument:
