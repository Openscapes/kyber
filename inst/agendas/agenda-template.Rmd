...
_All Champions program slides are also linked from [https://openscapes.github.io/series](https://openscapes.github.io/series) _
...
* Keyboard Shortcuts Part 1: Useful for any application (docs, email, code)
    ...
    * **Windows:** Arrow keys + Ctrl + Fn + shift, & in combination
