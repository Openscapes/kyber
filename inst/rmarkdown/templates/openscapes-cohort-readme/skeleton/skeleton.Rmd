...
Welcome to the `r db$cr$cohort_name_long` Cohort! This is a Cohort for [TODO: who is this cohort for?]. Please see the [Champions Program Lesson Series](https://openscapes.github.io/series) for what to expect, outcomes, and to browse the open lesson materials.
